            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row mb-3 form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="product_garage" value="{{ $product->product_garage }}" class="form-control" >
                        </div>
                    </div>
                    ...
                    <div class="row mb-3 form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="product_store" value="{{ $product->product_store }}" class="form-control" >
                        </div>
                    </div>
                    ...
                    <div class="row mb-3 form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="date" name="buying_date" value="{{ $product->buying_date }}" class="form-control" >
                        </div>
                    </div>
                    ...
                    <div class="row mb-3 form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="buying_price" value="{{ $product->buying_price }}" class="form-control" >
                        </div>
                    </div>
